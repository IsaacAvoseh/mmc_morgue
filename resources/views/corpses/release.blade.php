    ...
    <div class="container-fluid">
        ...
        <div class="row">
           ...
           @if ($release == 'no')
                <div class="col">
               @if ($file_message != 'no')
                   <p class="font-weight-bold text-danger" >** {{ $file_message?? '' }}. <a href="{{ route('update_before_release', ['id' => base64_encode($data->id) ]) }}">Click here to upload</a></p>
               @endif

               @if ($payment_message != 'no')
                   <p class="font-weight-bold text-danger" >** {{ $payment_message?? '' }}. <a href="{{ route('update_before_release', ['id' => base64_encode($data->id) ]) }}">Click here to pay</a></p>
               @endif
            </div>
           @endif
                        ...
                        <div class="modal-body" id="admission_form">
                               <form action="{{ route('release') }}" method="POST" id="form">
                                    ...
                                    <input type="hidden" name="corpse_id" id="corpse_id">

                                    <div class="form-group">
                                        <label>Name of Deceased:</label>
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                            <input type="text" name="name" id="name"
                                                value="{{$data->name?? old('name') }}" class="form-control datetimepicker-input"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="reservationdate"
                                                    ...
                                                    <input type="date" name="date_admit" id="date_admit"
                                                        value="{{$data->date_from?? old('date_admit') }}"
                                     ...
                                     <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdate"
                                                data-target-input="nearest">
                                                <input type="text" name="address" id="address" value="{{ $data->address?? old('address') }}"
                                                    class="form-control datetimepicker-input"
                                                    placeholder="Address of Deceased" required readonly>
                                            </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="reservationdate"
                                                    ...
                                                    <input type="number" name="age" id="age"
                                                        ...
                                                        class="form-control datetimepicker-input"
                                                        placeholder="76" required readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                       ...
                                       @if ($release == 'no')
                                           <a href="{{ route('get_corpse',['id' => base64_encode($data->id)]) }}" class="btn btn-warning text-white font-weight-bold"
                                           >Go to Corpse file</a>
                                       @else
