        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="message-box">
                    <h1 class="m-b-0">503</h1>
                    <p>Unavailable.</p>
                    <div class="buttons-con">
                        <div class="action-link-wrap">
                            <a href="{{ url()->previous() }}"
                                class="btn btn-custom btn-info waves-effect waves-light m-t-20">Go Back</a>
                            <a href="/" class="btn btn-custom btn-info waves-effect waves-light m-t-20"
                                style="background: #5DC560">Go to Home Page</a>
                        </div>
                    </div>
                </div>
            </div>
